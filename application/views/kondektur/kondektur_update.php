...
<html lang="en">
	...
	<body style="width: 100vw; height: 100vh;">
		...
		<div class="absolute-center">
			<div class="card">
				<div class="card-header">
					Update new kondektur
				</div>
				<div class="card-body">
					<form action="<?Php Echo Base_url('index.php/Kondektur_controller/edit/'.$current_kondektur->id_kondektur) ?>" method="post">
						<div class="form-group">
							<label for="exampleInputEmail1">Kondektur's name</label>
							<input type="text" class="form-control" id="" name='KondekturName' placeholder="Update kondektur's name" value="<?Php echo $current_kondektur->nama ?>">
						</div>
