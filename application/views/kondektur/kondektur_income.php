...
<html lang="en">
	...
	<body style="width: 100vw; height: 100vh;">
		...
		<div class="absolute-center">
			<div class="card">
				<div class="card-header">
					Current kondektur income <?Php echo $id_kondektur?>
				</div>
				<div class="card-body">
					<form action="<?Php Echo Base_url('index.php/Kondektur_controller/filterByMonth/'.$id_kondektur) ?>" method="post">
					...
					<table class="table mt-5">
						...
						<tbody>
						<?php foreach ($kondektur_income as $no => $row) : ?>
							<tr>
								<td><?= $no+1 ?></td>
