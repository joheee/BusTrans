	...
	<body style="width: 100vw; height: 100vh;">
		...
		<div class="absolute-center">
			<div class="card">
				...
				<div class="card-body">
					<form action="<?Php Echo Base_url('index.php/Driver_controller/save') ?>" method="post">
						<div class="form-group">
							<label for="exampleInputEmail1">Driver's name</label>
							<input type="text" class="form-control" id="" name='DriverName' placeholder="Enter driver's name">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Driver's SIM number</label>
							<input type="number" class="form-control" id="" name='DriverNumber' placeholder="Enter driver's SIM number">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Driver's address</label>
							<input type="text" class="form-control" id="" name='DriverAddress' placeholder="Enter driver's address">
						</div>	
