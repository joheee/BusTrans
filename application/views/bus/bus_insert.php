	...
	<body style="width: 100vw; height: 100vh;">
		...
		<div class="absolute-center">
			<div class="card">
				...
				<div class="card-body">
					<form action="<?Php Echo Base_url('index.php/Bus_controller/save') ?>" method="post">
						<div class="form-group">
							<label for="exampleInputEmail1">Plat Bus</label>
							<input type="text" class="form-control" id="" name='BusPlat' placeholder="Enter plat bus">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">Status Bus</label>
							<input type="number" class="form-control" id="" name='BusStatus' placeholder="Enter status bus">
						</div>
